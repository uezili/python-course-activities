...
listNumero = [] #*lista vazia para ser adicionado os dados.
while True: #*aqui temos um loop para fazer as perguntas aos usuários.
    ...
    if numero not in listNumero:
        listNumero.append(numero)#*O numero será colocado dentro(append) da lista.
    ...
    if resp == "N":
        break
print(f"A lista digitada foi {sorted(listNumero)}")