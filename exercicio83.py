...
lista = list() #* listForSam onde será colocado os parenteses da expressão

#* Para cada elemente(i) da expressão ele falará...
for i in expr:
    #* Se o elemento(i) for igual a um "(" ele adcionara na listForSam.
    if i == '(':
        lista.append(i)
    #* Se for um ")" ele apagará o ultimo elemento da listForSam, pois o parentese vai ter encontrado seu par
    elif i == ')':
        lista.pop()

#* Se o numero de itens na listForSam for igual a zero,ele fará...
if len(lista) == 0:
